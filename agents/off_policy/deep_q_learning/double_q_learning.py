...
from agents.off_policy.deep_q_learning.abstract_q_learning_agent import AbstractDoubleQLearningAgent
...
class DoubleQLearningAgent(AbstractDoubleQLearningAgent):
    ...
    def step(self, experiences):
        ...
        loss_1 = self._compute_loss(self.policy_network_1, self.target_network_2, batch_experiences)
        loss_2 = self._compute_loss(self.policy_network_2, self.target_network_1, batch_experiences)

        super().step(loss_1 + loss_2)
